...
export default function WallPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (loading) return <div className="h-screen flex items-center justify-center font-bold text-rose-500 animate-pulse text-xl tracking-tighter">Gathering the envelopes...</div>;
    ...
    <motion.div initial={{ x: '100%' }} animate={{ x: 0 }} className="flex-1 flex flex-col bg-gray-50 z-50 overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
        ...
        <div className="space-y-4 bg-white p-6 rounded-2xl shadow-sm">
          <label className="text-xs font-bold text-gray-400 uppercase tracking-widest">1. Pick a Seal</label>
