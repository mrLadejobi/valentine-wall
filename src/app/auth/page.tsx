...
import { Heart, Mail, Lock, Inbox, Sparkles, AlertCircle, User, Loader2 } from 'lucide-react';
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <a href="/auth/forgot-password" className="text-[10px] font-bold text-rose-400 hover:text-rose-600 transition-colors">Forgot Password?</a>
                </div>
                <div className="relative">
