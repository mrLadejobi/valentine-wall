        ...
        {isEmailSent ? (
          ...
          >
            ...
            <form onSubmit={handleReset} className="space-y-4">
              ...
              {resetEmailSent && (
                <motion.div initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} className="text-rose-600 text-xs font-bold flex items-center gap-1 ml-1">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 flex justify-center">
              <button 
                onClick={() => { setIsReset(false); setErrorMsg(null); setResetEmailSent(false); }} 
