        ...
        {isEmailSent ? (
          ...
          >
            ...
            <p className="text-gray-600 mb-8 font-medium leading-relaxed px-4">
              ...
              <span className="text-rose-600 font-bold">{email}</span>. Click it
              to verify your wall!
            </p>
            <motion.button
            ...
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 mt-2 font-medium">
                {isLogin
                  ...
                  : "Start your digital celebration today."}
              </p>
            </div>
            ...
            <form onSubmit={handleAuth} className="space-y-4">
              ...
              {errorMsg && (
                <motion.div
                  ...
                  className="text-red-500 text-[10px] font-bold flex items-center gap-1 ml-1 bg-red-50 p-2 rounded-lg border border-red-100 uppercase tracking-tighter"
                >
...
export default function AuthPage() {
  return (
    <main className="min-h-screen bg-linear-to-br from-pink-50 to-rose-100 flex items-center justify-center p-6 relative overflow-hidden">
      <FloatingHearts />
      <Suspense
        fallback={<Loader2 className="animate-spin text-rose-500" size={40} />}
      >
        <AuthContent />
      </Suspense>
    </main>
